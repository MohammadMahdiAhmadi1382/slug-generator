...
function SlugGenerator({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: (0, import_clsx.default)("w-full space-y-1.5", className), children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "flex items-center gap-2 text-sm font-medium text-(--color-text-primary)", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label }) }),
